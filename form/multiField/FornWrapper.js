...
var FornWrapper = exports.FornWrapper = function (_View) {
	_inherits(FornWrapper, _View);

	function FornWrapper(args, path) {
		var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'GET';
		var customFields = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};

		_classCallCheck(this, FornWrapper);

		var _this = _possibleConstructorReturn(this, (FornWrapper.__proto__ || Object.getPrototypeOf(FornWrapper)).call(this, args));
