	...
	_createClass(View, [{
		...
		value: function setCreateForm(args) {
			...
			if (this.args.attrs['data-create-endpoint'] !== false) {
				this.args.createForm = new _CreateForm.CreateForm(Object.assign({}, args), this.args.attrs['data-create-endpoint'] ? this.args.attrs['data-create-endpoint'] : args.publicId ? this.args.attrs['data-endpoint'] + '/' + args.publicId + '/edit' : this.args.attrs['data-endpoint'] + '/create');
