...
export class TestBase extends Test
{
	...
	helpers = [
		...
		, {
			inits: [
				() => { const o = console.assert;   const assert = (...a) => { (window.externalAssert||o)(JSON.stringify(a)); o(...a); }; window.console.assert = assert; }
			]
			, bindings: [ ['externalAssert', (...a) => this.assertSilent(...a)] ]
		}
	];
