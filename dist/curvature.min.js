...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Database=void 0;var _Bindable=require("../base/Bindable"),_Mixin=require("../base/Mixin"),_EventTargetMixin=require("../mixin/EventTargetMixin");function _typeof(a){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}function _toConsumableArray(a){return _arrayWithoutHoles(a)||_iterableToArray(a)||_unsupportedIterableToArray(a)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(a,b){if(a){if("string"==typeof a)return _arrayLikeToArray(a,b);var c=Object.prototype.toString.call(a).slice(8,-1);return"Object"===c&&a.constructor&&(c=a.constructor.name),"Map"===c||"Set"===c?Array.from(a):"Arguments"===c||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c)?_arrayLikeToArray(a,b):void 0}}function _iterableToArray(a){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(a))return Array.from(a)}function _arrayWithoutHoles(a){if(Array.isArray(a))return _arrayLikeToArray(a)}function _arrayLikeToArray(a,b){(null==b||b>a.length)&&(b=a.length);for(var c=0,d=Array(b);c<b;c++)d[c]=a[c];return d}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function _defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}function _createClass(a,b,c){return b&&_defineProperties(a.prototype,b),c&&_defineProperties(a,c),a}function _inherits(a,b){if("function"!=typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),b&&_setPrototypeOf(a,b)}function _setPrototypeOf(a,b){return _setPrototypeOf=Object.setPrototypeOf||function(a,b){return a.__proto__=b,a},_setPrototypeOf(a,b)}function _createSuper(a){var b=_isNativeReflectConstruct();return function(){var c,d=_getPrototypeOf(a);if(b){var e=_getPrototypeOf(this).constructor;c=Reflect.construct(d,arguments,e)}else c=d.apply(this,arguments);return _possibleConstructorReturn(this,c)}}function _possibleConstructorReturn(a,b){return b&&("object"===_typeof(b)||"function"==typeof b)?b:_assertThisInitialized(a)}function _assertThisInitialized(a){if(void 0===a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return a}function _isNativeReflectConstruct(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(a){return!1}}function _getPrototypeOf(a){return _getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(a){return a.__proto__||Object.getPrototypeOf(a)},_getPrototypeOf(a)}var PrimaryKey=Symbol("PrimaryKey"),Connection=Symbol("Connection"),Instances=Symbol("Instances"),HighWater=Symbol("HighWater"),Metadata=Symbol("Metadata"),Timers=Symbol("Timers"),Target=Symbol("Target"),Store=Symbol("Store"),Fetch=Symbol("Each"),Name=Symbol("Name"),Bank=Symbol("Bank"),Database=function(a){function b(a){var d;return _classCallCheck(this,b),d=c.call(this),Object.defineProperty(_assertThisInitialized(d),Connection,{value:a}),Object.defineProperty(_assertThisInitialized(d),Name,{value:a.name}),Object.defineProperty(_assertThisInitialized(d),Timers,{value:{}}),Object.defineProperty(_assertThisInitialized(d),Metadata,{value:{}}),Object.defineProperty(_assertThisInitialized(d),Bank,{value:{}}),d}_inherits(b,a);var c=_createSuper(b);return _createClass(b,[{key:"select",value:function select(a){var b=this,c=a.store,d=a.index,e=a.range,f=void 0===e?null:e,g=a.direction,h=void 0===g?"next":g,j=a.limit,k=void 0===j?0:j,l=a.offset,m=void 0===l?0:l,n=a.type,o=void 0!==n&&n,p=a.origin,q=void 0===p?void 0:p,r=this[Connection].transaction(c,"readonly"),t=r.objectStore(c),s=d?t.index(d):t;return{each:this[Fetch](o,s,h,f,k,m,q),one:this[Fetch](o,s,h,f,1,m,q),then:function then(a){return b[Fetch](o,s,h,f,k,m,q)(function(a){return a}).then(a)}}}},{key:"insert",value:function insert(a,c){var d=this,e=2<arguments.length&&void 0!==arguments[2]?arguments[2]:void 0;return new Promise(function(f,g){d[Bank][a]=d[Bank][a]||{};var h=d[Connection].transaction([a],"readwrite"),i=h.objectStore(a),j=d[Bank][a];c=_Bindable.Bindable.make(c);var k=i.add(Object.assign({},c));k.onerror=function(b){d.dispatchEvent(new CustomEvent("writeError",{detail:{database:d[Name],record:c,store:a,type:"write",subType:"insert",origin:e}})),g(b)},k.onsuccess=function(g){var i=g.target.result;j[i]=c;var k=d.dispatchEvent(new CustomEvent("write",{detail:{database:d[Name],key:b.getPrimaryKey(c),store:a,type:"write",subType:"insert",origin:e}}));if(k){if(c[PrimaryKey]=Symbol["for"](i),d[Metadata][a]||(d[Metadata][a]=d.getStoreMeta(a,"store",{})),d[Metadata][a]){var l=d[Metadata][a],m=d.checkHighWaterMark(a,c),n=c[l.highWater];m<n&&d.setHighWaterMark(a,c,e,"insert")}h.commit()}else h.abort();f(c)}})}},{key:"update",value:function update(a,c){var d=this,e=2<arguments.length&&void 0!==arguments[2]?arguments[2]:void 0;if(!c[PrimaryKey])throw Error("Value provided is not a DB record!");return new Promise(function(f,g){var h=d[Connection].transaction([a],"readwrite"),i=h.objectStore(a),j=i.put(Object.assign({},c));j.onerror=function(f){d.dispatchEvent(new CustomEvent("writeError",{detail:{database:d[Name],key:b.getPrimaryKey(c),record:c,store:a,type:"write",subType:"update",origin:e}})),g(f)},j.onsuccess=function(g){var i=d.dispatchEvent(new CustomEvent("write",{detail:{database:d[Name],record:c,key:b.getPrimaryKey(c),store:a,type:"write",subType:"update",origin:e}}));if(!i)h.commit();else if(d[Metadata][a]||(d[Metadata][a]=d.getStoreMeta(a,"store",{})),d[Metadata][a]){var j=d[Metadata][a],k=d.checkHighWaterMark(a,c),l=c[j.highWater];k<l&&d.setHighWaterMark(a,c,e,"update")}f(g)}})}},{key:"delete",value:function _delete(a,c){var d=this,e=2<arguments.length&&void 0!==arguments[2]?arguments[2]:void 0;if(!c[PrimaryKey])throw Error("Value provided is not a DB record!");return new Promise(function(f,g){var h=d[Connection].transaction([a],"readwrite"),i=h.objectStore(a),j=i["delete"](+c[PrimaryKey].description);j.onerror=function(f){var h=new CustomEvent("writeError",{detail:{database:d[Name],original:event,key:b.getPrimaryKey(c),store:a,type:"write",subType:"delete",origin:e}});d.dispatchEvent(h),g(f)},j.onsuccess=function(g){var i=new CustomEvent("write",{detail:{database:d[Name],original:g,key:b.getPrimaryKey(c),store:a,type:"write",subType:"delete",origin:e}});d.dispatchEvent(i),h.commit(),f(i)}})}},{key:"listStores",value:function listStores(){return _toConsumableArray(this[Connection].objectStoreNames)}},{key:"listIndexes",value:function listIndexes(a){var b=this[Connection].transaction([a]),c=b.objectStore(a);return _toConsumableArray(c.indexNames)}},{key:Fetch,value:function value(a,b,c,d,e,f,g){var h=this;return function(j){return new Promise(function(k){var l=0,m=b.openCursor(d,c);m.addEventListener("success",function(c){var d=c.target.result;if(!d)return k({record:null,result:null,index:l});if(f>l++)return d["continue"]();var i=d.source,m=i.objectStore?i.objectStore.name:b.name;h[Bank][m]=h[Bank][m]||{};var n=h[Bank][m],o=d.primaryKey,p=a?a.from(d.value):d.value;n[o]?Object.assign(n[o],p):(p[PrimaryKey]=Symbol["for"](o),n[o]=_Bindable.Bindable.makeBindable(p)),h.dispatchEvent(new CustomEvent("read",{detail:{database:h[Name],record:p,store:m,type:"read",subType:"select",origin:g}}));var q=j?j(n[o],l):n[o];return e&&l-f>=e?(f+=e,k({record:n[o],result:q,index:l})):void d["continue"]()})})}}},{key:"setStoreMeta",value:function setStoreMeta(a,b,c){localStorage.setItem("::::cvdb::".concat(a,"::").concat(b),JSON.stringify(c))}},{key:"getStoreMeta",value:function getStoreMeta(a,b,c){var d=localStorage.getItem("::::cvdb::".concat(a,"::").concat(b));return d?JSON.parse(d):c}},{key:"createObjectStore",value:function createObjectStore(a,b){var c=this[Connection].createObjectStore(a,b);return this.setStoreMeta(a,"store",b),c}},{key:"deleteObjectStore",value:function deleteObjectStore(a){return this[Connection].deleteObjectStore(a)}},{key:"checkHighWaterMark",value:function checkHighWaterMark(a){var b=2<arguments.length&&void 0!==arguments[2]?arguments[2]:void 0,c=this.getStoreMeta(a,"highWater",0);return c}},{key:"setHighWaterMark",value:function setHighWaterMark(a,b){var c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:void 0,d=3<arguments.length&&void 0!==arguments[3]?arguments[3]:void 0,e=this[Metadata][a],f=b[e.highWater],g=this.getStoreMeta(a,"highWater",0);this.setStoreMeta(a,"highWater",f),this.dispatchEvent(new CustomEvent("highWaterMoved",{detail:{database:this[Name],record:b,store:a,type:"highWaterMoved",subType:d,origin:c,oldValue:g,value:f}}))}}],[{key:"open",value:function open(a){var c=this,d=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0;return this[Instances][a]?Promise.resolve(this[Instances][a]):new Promise(function(e,f){var g=indexedDB.open(a,d);g.onerror=function(a){b.dispatchEvent(new CustomEvent("readError",{detail:{database:c[Name],error:a,store:void 0,type:"read",subType:"select"}})),f(a)},g.onsuccess=function(b){var d=new c(b.target.result);c[Instances][a]=d,e(d)},g.onupgradeneeded=function(b){var e=b.target.result;e.addEventListener("error",function(a){return console.error(a)});for(var f=new c(e),g=b.oldVersion+1;g<=d;g+=1)f["_version_"+g](e);c[Instances][a]=f}})}},{key:"getPrimaryKey",value:function getPrimaryKey(a){return a[PrimaryKey]?a[PrimaryKey].description:null}},{key:"destroyDatabase",value:function destroyDatabase(){var a=this;return new Promise(function(c,d){var e=indexedDB["delete"](dbName);e.onerror=function(a){b.dispatchEvent(new CustomEvent("destroyError",{detail:{database:dbName,error:a,type:"destroy"}})),d(a)},e.onsuccess=function(){delete a[Instances][dbName],c(dbName)}})}}]),b}(_Mixin.Mixin["with"](_EventTargetMixin.EventTargetMixin));exports.Database=Database,Object.defineProperty(Database,Instances,{value:[]}),Object.defineProperty(Database,Target,{value:new EventTarget});var _loop=function(a){Object.defineProperty(Database,a,{value:function value(){var b;return(b=Database[Target])[a].apply(b,arguments)}})};for(var method in Database[Target])_loop(method);
