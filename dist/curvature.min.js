...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.PromiseMixin=void 0;var _PromiseMixin,_Mixin=require("../base/Mixin");function _defineProperty(a,b,c){return b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c,a}var _Promise=Symbol("Promise"),Accept=Symbol("Accept"),Reject=Symbol("Reject"),PromiseMixin=(_PromiseMixin={},_defineProperty(_PromiseMixin,_Mixin.Mixin.Constructor,function(){var a=this;this[_Promise]=new Promise(function(b,c){a[Accept]=b,a[Reject]=c})}),_defineProperty(_PromiseMixin,"then",function then(){var a;return(a=this[_Promise]).then.apply(a,arguments)}),_defineProperty(_PromiseMixin,"catch",function _catch(){var a;return(a=this[_Promise])["catch"].apply(a,arguments)}),_defineProperty(_PromiseMixin,"finally",function _finally(){var a;return(a=this[_Promise])["finally"].apply(a,arguments)}),_PromiseMixin);exports.PromiseMixin=PromiseMixin;
