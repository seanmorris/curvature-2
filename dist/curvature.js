...
var Sequence = function (_Mixin$with) {
  ...
  function Sequence(_ref) {
    ...
    var _ref2 = [callback, timing, keys];
...
var Database = function (_Mixin$with) {
  ...
  _createClass(Database, [{
    ...
    value: function select(_ref) {
      ...
      return {
        ...
        then: function then(c) {
          return _this2[Fetch](type, i, direction, ranges, limit, offset, origin)(function (e) {
            return e;
          }).then(c);
        }
      };
    ...
    key: Fetch,
    value: function value(type, index, direction, ranges, limit, offset, origin) {
      var _this7 = this;
